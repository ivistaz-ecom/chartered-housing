import {
  whyChooseCharteredBirdsongCol1,
  whyChooseCharteredBirdsongCol2,
  whyChooseCharteredCol1,
} from "@/lib/constants/whyChooseChartered"
    ...
    <div className="mt-10">
      <div className="max-w-7xl mx-auto bg-[#DBDBDB4D] p-10">
        ...
        <div className="grid grid-cols-2 gap-10 divide-x divide-dotted divide-[#ED1C25] pb-0 p-10">
          {/* column 1 */}
          <div>
            <h3 className="text-3xl text-primary-gray mb-7">Specifications</h3>
            <ul className="flex flex-col gap-5 list-disc marker:text-[#ED1C25] text-lg text-[#646464]">
              {whyChooseCharteredBirdsongCol1.map((point, i) => (
                <li key={i}>{point}</li>
              ))}
            </ul>
          </div>
          {/* column 2 */}
          <div>
            <h3 className="text-3xl text-primary-gray mb-7">
              Location Advantage
            </h3>
            <ul className="flex flex-col gap-5 list-disc marker:text-[#ED1C25] text-lg text-[#646464]">
              {whyChooseCharteredBirdsongCol2.map((point, i) => (
                <li key={i} className="">
                  {point}
                </li>
              ))}
