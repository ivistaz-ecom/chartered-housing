          ...
          <div className="space-y-3 border-b border-black pb-7">
            ...
            <div className="flex gap-3 items-center">
              <p>
                ...
                <a href="tel:+919900592343" className=" hover:text-[#ec1d23]">
                  +91 990 059 2343
                </a>{" "}
                /{" "}
                <a href="tel:+918031021400" className=" hover:text-[#ec1d23]">
                  +91 803 102 1400
                </a>
              </p>
              ...
              <div className="space-y-5">
                ...
                <ul className="space-y-3">
                  {ourProjectsMenu.map((item, idx) => (
                    <li key={idx}>
                      <Link href={item.path} className=" hover:text-[#ec1d23]">
                        {item.menu}
                      </Link>
                    </li>
                  ))}
